...
void StateWarGame::Exit(beStateMachine* stateMachine)
{
...
void StateWarGame::Update(beStateMachine* stateMachine, float dt)
{
	...
	if (keyboard->IsPressed(beKeyboard::Button::R))
	{
		m_cells.Restart();
	}
