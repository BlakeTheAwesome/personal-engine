...
//}
//
//void WarGameCells::UpdateBlock(WarGameCells::Block* block, float xPos, float yPos, float distance, bool highlight)
//{
...
//}
//
//void WarGameCells::InitBlock(WarGameCells::Block* block, float xPos, float yPos, float height)
//{
//	//-x
//	int faceOffset = 0;
