...
//	struct 
//
//	static void UpdateBlock(WarGameCells::Block* block, float xPos, float yPos, float height, bool highlight);
//	static void InitBlock(WarGameCells::Block* block, float xPos, float yPos, float height);
//
//	beFont m_font;
