...
template <typename T, typename U, template <typename, int> class vectorPolicy, int Policy_Size>
class beHashMapBase
{
	public:
	using key_type = T;
...
template <typename key_type, typename value_type, int INITIAL_CAPACITY=16>
class beHashMapHeap : public beHashMapBase<key_type, value_type, beVectorMallocPolicy, INITIAL_CAPACITY>
{
};

template <typename key_type, typename value_type, int CAPACITY=16>
