...
export template<typename T, VectorMemoryPolicy Policy>
...
export template <typename T, int HYBRID_CAPACITY=16>
...
export template <typename T, int INITIAL_SIZE=8>
