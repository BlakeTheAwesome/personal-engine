export module beByteStreams;

import beDataBuffer;
import beTypes;

export class beByteStreamBase
{
	public:
		using dataSize = u32;
...
export class beReadStream : public beByteStreamBase
{
	public:
...
export class beWriteStream : public beByteStreamBase
{
	public:
...
export template< int streamSize >
